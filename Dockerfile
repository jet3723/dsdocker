...
RUN apk update && apk upgrade && \
    apk add xorg-server mesa-egl xf86-video-fbdev xf86-video-vesa xf86-input-mouse xf86-input-keyboard dbus setxkbmap kbd xrandr xset

RUN apk add bash    
RUN apk add mesa libxi

FROM alpine-glibc

LABEL MAINTAINER="Anaconda, Inc"
ENV ANACONDA_VERSION 2020.07
ENV ANACONDA_MD5 1046c40a314ab2531e4c099741530ada
...
RUN apk --no-cache add sudo && \
    ...
    sudo usermod -g wheel anaconda
RUN echo 'anaconda:anaconda' | chpasswd
